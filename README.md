...
* https://infostart.ru/public/126781/ (done) Консоль запросов, версия 1.8.1 для управляемого приложения тонкий клиент. Интеграция с режимом отладки 1300 скачиваний
* https://infostart.ru/public/177142/ (done) Консоль запросов 1С 8.2 УФ и ОФ Санёк 716	скачиваний
